...
select distinct "Inventory6"."Branch_Plant" "Branch_Plant", "Inventory6"."Global_Bulk_Item" "Global_Bulk_Item", "Inventory6"."Bulk_Item" "Bulk_Item", "Inventory6"."C_2nd_Item_Number" "C_2nd_Item_Number", "Inventory6"."Lot_Number" "Lot_Number", "Quality7"."Lot_Number" "Lot_Number1", "Quality7"."Supplier_Lot_Number" "Supplier_Lot_Number", "Quality7"."On_Hand_Date" "On_Hand_Date", "Quality7"."Expiration_Date_Month" "Expiration_Date_Month", "Inventory6"."TIME24" "TIME10"
 ...
 order by "Global_Bulk_Item" asc nulls last, "Bulk_Item" asc nulls last, "C_2nd_Item_Number" asc nulls last, "Branch_Plant" asc nulls last, "Lot_Number" asc nulls last
