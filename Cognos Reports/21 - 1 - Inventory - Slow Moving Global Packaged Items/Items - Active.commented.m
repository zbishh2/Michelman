// Items - Active uses BIQLTabular Item Branch at item-branch grain.
// The source query keeps active packaged items in the report branch set and
// normalizes displayed keys before DISTINCT removes duplicate projections.
let
