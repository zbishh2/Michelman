// ============================================================================
// Report 09 - Ivan FC 2023   (page 3 of 5: "Sales Orders")
...
//   (Cognos quirk - kept verbatim), plus II.Bulk_Item in the 31-entry whitelist.
//
    ...
    Data = Value.NativeQuery(
        ...
        LEFT OUTER JOIN (
            ...
            WHERE os.SDLNTY = 'S'
              ...
              AND LTRIM(RTRIM(os.SDMCU)) IN ('AUBA', 'AUB2', 'SING', 'SNG4', 'MUM3', 'SHAN')
            GROUP BY
