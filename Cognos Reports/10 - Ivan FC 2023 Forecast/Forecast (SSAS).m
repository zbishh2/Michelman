// ============================================================================
// 10 - Ivan SFC2023 Forecast   ->   PAGE "Forecast"  --  SSAS-SOURCED VARIANT (team preference)
// Twin of Forecast.m (EDW): SAME 19 columns, SAME filters, SAME slicer design.
// Lives in `PBIP (SSAS)\` as "1 - Ivan FC 2023 Forecast (SSAS)" so both versions can be published
    ...
    Source = AnalysisServices.Database(
        ...
        SELECTCOLUMNS(
            SUMMARIZECOLUMNS(
                ...
                FILTER(ALL(FactForecast[BusinessUnit]), NOT FactForecast[BusinessUnit] IN {""CINC"", ""CIN2""}),
