// ============================================================================
// Report 18  ·  1 - Singapore Warehouse Inv 2025  ·  page table: Americas Inventory
// Cognos query object: Americas - Inventory  (DW_LEGACY "Inventory On Hand Star Schema")
    ...
    Data = Value.NativeQuery(
        ...
        FROM (
            ...
            WHERE (snap.QuantityOnHandPrimaryUOM > 0 OR snap.ItemCostSKey <> -1)
              AND LTRIM(RTRIM(snap.BusinessUnit)) IN ('CINC', 'CIN2', 'CIN4')
