...
TABLES["Shipments"] = dict(
    ...
    cols=[
        ...
        C("Order Net Amount USD (Line)", "double", N0, True, "Line-grain input to [Order Net Amount USD]: the cube's net amount USD plus the back-ordered extended amount."),
        C("Order Net Amount EUR (Line)", "double", N0, True, "Line-grain input to [Order Net Amount EUR]: native EUR net plus back-order for EUR-currency companies, otherwise the USD total at the month-end EUR/USD rate A of the GL date."),
